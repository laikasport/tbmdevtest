...
class Frontend_Scripts implements Service, Registerable, Conditional {
	...
	public function register_styles() {
		wp_register_style( 'dlp-folders', $this->asset_url( 'css/dlp-folders.min.css' ), [], $this->plugin->get_version() );
		wp_register_style( 'dlp-table', $this->asset_url( 'css/dlp-table.min.css' ), [], $this->plugin->get_version() );
		wp_register_style( 'dlp-grid', $this->asset_url( 'css/dlp-grid.min.css' ), [], $this->plugin->get_version() );
		wp_register_style( 'dlp-search-box', $this->asset_url( 'css/dlp-search-box.min.css' ), [], $this->plugin->get_version() );

		if ( is_singular( Post_Type::POST_TYPE_SLUG ) ) {
			wp_enqueue_style( 'dlp-single-post', $this->asset_url( 'css/dlp-single-post.min.css' ), [], $this->plugin->get_version() );
		}
	...
	public function register_scripts() {
		...
		// Folders
		$script_dependencies = array_merge( Lib_Util::get_script_dependencies( $this->plugin, './assets/js/dlp-folders.min.js' )['dependencies'], [ 'jquery', 'jquery-blockui' ] );
		wp_register_script( 'dlp-folders', $this->asset_url( 'js/dlp-folders.min.js' ), $script_dependencies, $this->plugin->get_version(), true );
		...
		// Grid
		$script_dependencies = array_merge( Lib_Util::get_script_dependencies( $this->plugin, './assets/js/dlp-grid.min.js' )['dependencies'], [ 'jquery', 'jquery-blockui' ] );
		wp_register_script( 'dlp-grid', $this->asset_url( 'js/dlp-grid.min.js' ), $script_dependencies, $this->plugin->get_version(), true );
		Util::add_inline_script_params(
			'dlp-grid',
			'dlp_grid_params',
			[
		...
		// Download Zip
		wp_register_script( 'dlp-download-zip', $this->asset_url( 'js/dlp-download-zip.min.js' ), [], $this->plugin->get_version(), true );
		wp_register_script( 'dlp-multi-download', $this->asset_url( 'js/dlp-multi-download.min.js' ), [ 'jquery', 'dlp-download-zip' ], $this->plugin->get_version(), true );
		wp_localize_script(
			'dlp-multi-download',
		...
		wp_register_script( 'dlp-preview', $this->asset_url( 'js/dlp-preview.min.js' ), [ 'jquery', 'micromodal' ], $this->plugin->get_version(), true );
		wp_localize_script(
			'dlp-preview',
			'dlp_preview_params',
			[
		...
		// Download Count
		$script_dependencies = array_merge( Lib_Util::get_script_dependencies( $this->plugin, './assets/js/dlp-count.min.js' )['dependencies'], [ 'jquery' ] );
		wp_register_script( 'dlp-count', $this->asset_url( 'js/dlp-count.min.js' ), $script_dependencies, $this->plugin->get_version(), true );
		Util::add_inline_script_params(
			'dlp-count',
			'dlp_count_params',
			[
