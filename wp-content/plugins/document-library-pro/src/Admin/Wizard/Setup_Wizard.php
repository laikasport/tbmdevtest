...
use Barn2\Plugin\Document_Library_Pro\Admin\Wizard\Steps,
	...
	Barn2\DLP_Lib\Plugin\License\EDD_Licensing,
	Barn2\DLP_Lib\Plugin\License\Plugin_License,
	Barn2\DLP_Lib\Plugin\Licensed_Plugin,
	Barn2\DLP_Lib\Registerable,
	Barn2\DLP_Lib\Util as Lib_Util;
use Barn2\Plugin\Document_Library_Pro\Dependencies\Barn2\Setup_Wizard\Setup_Wizard as Wizard;
...
class Setup_Wizard implements Registerable {
	...
	public function __construct( Licensed_Plugin $plugin ) {
		...
		$wizard->add_custom_asset(
			$plugin->get_dir_url() . 'assets/js/admin/dlp-wizard-custom.min.js',
			Lib_Util::get_script_dependencies( $this->plugin, './assets/js/admin/dlp-wizard-custom.min.js' )
		);
