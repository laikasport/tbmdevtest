 ...
 */
namespace Barn2\Plugin\Document_Library_Pro\Dependencies\Composer\Autoload;
...
class ClassLoader
{
    ...
    public function findFile($class)
    {
        ...
        if (\false === $file && \defined('Barn2\\Plugin\\Document_Library_Pro\\Dependencies\\HHVM_VERSION')) {
